...
from i3d_src.DataLoader_i3d_k400_DS2_ge128 import RGB_jpg_train_Dataset, RGB_jpg_val_Dataset
...
def train_model(model_i3d, model_yolo_3d_bottom, opt,save_path, criterion, optimizer, \
        ...
        for i in range(start_sub_epoch, len_train_loader):    
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'val':
                    ...
                    s1 = "i3d_top_s224_k400_DS2_ge128_f16_"+d_t+"_"
...
def main(model_i3d, model_yolo_3d_bottom, num_sub_dataset, \
        train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size):     
    
    Num_Epochs = 200
    
    lr_list = [8.0e-2, 4.0e-2, 2.0e-2, 8.0e-3, 4.0e-3, 2.0e-3, 1.0e-3]
    lr = lr_list[0]
    lr_i = 0
    ...
    train_model(model_i3d, model_yolo_3d_bottom, opt,save_path, criterion, optimizer, \
            lr_i, lr_i_max, lr_list, Num_Epochs, start_epoch, start_sub_epoch, \
            train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size)  
...
if __name__ == "__main__":    
    ...
    #weight_i3d = 'weights/model_rgb.pth'
    ...
    model_i3d = modify_and_freeze_i3d_top(model_i3d, Num_Classes, 10)
    model_i3d.to(device) 
    ...
    main(model_i3d, model_yolo_3d_bottom, num_sub_dataset, \
        train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size)         
