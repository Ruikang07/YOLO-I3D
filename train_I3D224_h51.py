...
from i3d_src.DataLoader_i3d_h51_DS1_ge32 import RGB_jpg_train_Dataset, RGB_jpg_val_Dataset
...
def train_model(model_i3d, opt,save_path, criterion, optimizer, lr_i, lr_i_max, lr_list, num_epochs, \
            ...
            for phase in ['train', 'val']:
                ...
                for idx, (data,labels) in enumerate(progress):                 
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        out_softmax, out_logits = model_i3d(data)
                ...
                if phase == 'val':
                    ...
                    s1 = "i3d_s224_h51_DS1_ge32_f32_"+d_t+"_"
...
def main(model_i3d, train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size):     
    
    Num_Epochs = 200
    
    lr_list = [1.0e-3, 1.0e-4, 1.0e-5, 1.0e-6, 1.0e-4, 1.0e-5, 1.0e-6]  
    ...
    train_model(model_i3d, opt,save_path, criterion, optimizer, lr_i, lr_i_max, lr_list, Num_Epochs, \
            train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size)  
...
if __name__ == "__main__":    
    ...
    DropoutProb = 0.4
    weight_i3d = "weights/i3d_s224_k400_d1_f32_val_acc_0.6100.pth"
    ...
    ###############################################################################
    Num_Classes=51
    model_i3d = load_and_freeze_model(model_i3d, Num_Classes, 17)
    model_i3d.to(device) 
    ...
    main(model_i3d, train_data_loaders, val_data_loader, train_dataset_sizes, val_dataset_size)         
