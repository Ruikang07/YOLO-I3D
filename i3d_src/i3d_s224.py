...
class I3D_Bottom(torch.nn.Module):
    def __init__(self,
                 num_classes,
                 modality='rgb',
                 dropout_prob=0,
                 name='inception_bottom'):
        super(I3D_Bottom, self).__init__()
...
class I3D_Top(torch.nn.Module):
    def __init__(self,
                 num_classes,
                 modality='rgb',
                 dropout_prob=0,
                 name='inception_top'):
        super(I3D_Top, self).__init__()
